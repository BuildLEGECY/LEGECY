...
@app.get('/wallet/{wallet_address}',tags=['Wallet Intelligence'],summary='Analyze a Solana wallet',response_model=WalletProfileResponse,responses={400:{'model':ErrorResponse,'description':'Invalid wallet address or processing error.'},429:{'model':ErrorResponse,'description':'Rate limit exceeded.'},500:{'model':ErrorResponse,'description':'Wallet analysis failed.'},504:{'model':ErrorResponse,'description':'Wallet analysis timed out.'}})
