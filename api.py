...
load_dotenv()
APP_ENV=os.getenv('APP_ENV','development').strip().lower();API_VERSION='2.0.0';BASE_DIR=Path(__file__).resolve().parent;DASHBOARD_FILE=BASE_DIR/'dashboard'/'index.html'
